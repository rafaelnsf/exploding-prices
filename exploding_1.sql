...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Abr-2023 às 01:13
...
(1, 'SSD WD 240GB GREEN SATA3 2.5 7MM WDS240G2G0A', 'Velocidade de leitura de até 545 MB/s, muito leve e compacto, Dashboard gratuita da WD.', 195.00, '5', 'A', 0),
(2, 'SSD KINGSTON 1TB NV2 M.2 2280 NVME PCIE 4.0 - SNV2', 'Ideal para laptops e PCs de fator de forma pequeno, desempenho NVMe PCle 4.0 geração 4x4.', 341.00, '5', 'A', 0),
(3, 'SSD CRUCIAL 1TB BX500 3D NAND SATA3 2,5 7MM - CT10', 'SSD Series - BX500, Leitura: 540MB/s, Durabilidade: 360 TB.', 346.00, '3', 'A', 0),
